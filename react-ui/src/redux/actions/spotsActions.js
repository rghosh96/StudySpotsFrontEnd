...
import {
    ...
    SUBMIT_RATING, CREATE_COMMENT, DELETE_COMMENT, FETCH_COMMENTS_REQUEST, FETCH_COMMENTS_SUCCESS, FETCH_COMMENTS_FAILURE, UPDATE_COMMENT
} from '../actions/types';
import {
...
const NEARBY_SEARCH_RADIUS = 700; // in meters (about 6 miles). max is 50000
